...
import DatePicker from "@/components/time/date-time-select";
import { getLeavesByResourceId, cancelLeaveRequestById } from "@/src/actions/leave";
import SelectTable from "@/components/leave/leaveSelect";
...
interface LeaveHistoryType {
  ...
  description: string;
  duration: number;
  leaveType: string; // Ensure this is defined
  startDatePartial: string; // Ensure this is defined
  endDatePartial: string; // Ensure this is defined
}
...
interface LeaveHistoryPropsType {
  ...
  holidaysList:HolidaysProps[]| null 
